...
const SellerCreateServicePackage = () => {
    ...
    const createServicePackage = (data) => {
        data.userId = userProfile.userDetails._id
        setSpinner(true);
        axios.post(environment.API_URL + 'seller/service-package/create', data, {headers: {token: userProfile.token}})
        .then(response => {
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-8 col-md-8 mb-5">
                            ...
                            <form className="mt-2" onSubmit={handleSubmit(createServicePackage)}>
                                <div className="mb-3">
...
export default SellerCreateServicePackage
