...
const BuyerCreateJobPost = () => {
    ...
    const createNewJobPost = (data) => {
        setSpinner(true);
        axios.post(environment.API_URL + 'buyer/jobs/create', data, {headers: {token: userProfile.token}})
        .then(response => {
                ...
                <div className="container mb-5">
                    <div className="row">
                        ...
                        <div className="col-8 col-md-8">
                            <section>
                                <h4 className="text-center">Create New Job</h4>
                                <hr/>
                                {successMsg !== '' &&
                                ...
                                <form className="mt-2" onSubmit={handleSubmit(createNewJobPost)}>
                                    <div className="row">
                                        <div className="col">
                                            <div className="mb-3">
